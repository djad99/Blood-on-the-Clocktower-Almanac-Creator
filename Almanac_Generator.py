...
def create_master_almanac():
    ...
    title_page_credit = title_page.add_run("\nAutogenerated by BOTC Almanac Generator\nAlmanac Generator created by David Gray\nLink to GitHub:")
    title_page_credit.font.size = Pt(16)
    title_page_credit.font.name = "Dumbledor 1"

    doc.add_picture("Images/QR_Code/QR_Code.png", height=Inches(1.5))
    doc.paragraphs[-1].alignment = WD_ALIGN_PARAGRAPH.CENTER
...
def create_sub_almanac():
    ...
    title = script_characters[0]["name"]
    author = script_characters[0]["author"]
    ...
    if author != "":
        author_credit = title_page.add_run("\nScript by "+author)
        author_credit.font.size = Pt(20)
        author_credit.font.name = "Dumbledor 1"
        author_credit.bold = True
    ...
    filter_characters(script_characters)
